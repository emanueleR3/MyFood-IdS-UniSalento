...
import it.unisalento.myfood.View.Decorator.Pulsantiera.PulsantieraGestione.PulsantieraGestioneTipologieProdottiDecorator;
import it.unisalento.myfood.View.Frame;
import it.unisalento.myfood.Listener.Gestione.GestioneTipologieProdottiListener;
...
public class GestioneTipologieProdottiPanel extends JPanel {
    private Frame frame;
    ...
    private ActionListener gestioneTipologieProdottiListener;


    public GestioneTipologieProdottiPanel(Frame frame) {
        this.frame = frame;
        ...
        gestioneTipologieProdottiListener = new GestioneTipologieProdottiListener(this, frame);

        TextLabel title = new TextLabel("Gestione Tipologie Prodotti");
    ...
    public void setMenuBar(){
        ...
        while (iterator.hasNext()){
            ...
            menu.add(item);
            item.addActionListener(gestioneTipologieProdottiListener);
        }
    ...
    public void setPulsanti() {
        ...
        PulsantieraGestioneTipologieProdottiDecorator pulsantieraGestioneTipologieProdottiDecorator = new PulsantieraGestioneTipologieProdottiDecorator(pulsantieraGestione);

        ArrayList<JButton> buttons = pulsantieraGestioneTipologieProdottiDecorator.getPulsanti();


        JButton btnTornaDashboard = buttons.remove(0);
        btnTornaDashboard.addActionListener(gestioneTipologieProdottiListener);
        ...
        for (JButton btn : buttons) {
            ...
            btn.addActionListener(gestioneTipologieProdottiListener);
        }
