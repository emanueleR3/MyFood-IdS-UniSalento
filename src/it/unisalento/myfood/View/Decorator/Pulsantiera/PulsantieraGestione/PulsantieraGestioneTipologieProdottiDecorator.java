...
public class PulsantieraGestioneTipologieProdottiDecorator extends PulsantieraGestioneDecorator {
    ...
    public PulsantieraGestioneTipologieProdottiDecorator(Pulsantiera pulsantiera) {
    ...
    public ArrayList<JButton> getPulsanti() {
        ...
        btnAggiungi.setActionCommand(GestioneTipologieProdottiListener.AGGIUNGI_BTN);
        btnModifica.setActionCommand(GestioneTipologieProdottiListener.MODIFICA_BTN);
        btnRimuovi.setActionCommand(GestioneTipologieProdottiListener.RIMUOVI_BTN);
