...
public class AddTipologiaProdotto implements ITipoloagiaProdottoOperation {
    ...
    public AddTipologiaProdotto(String nomeTipologia) {
    ...
    public OperationTipologiaProdottoResult execute() {
        ...
        boolean done = tipologiaProdottoDAO.addTipologia(nomeTipologia);
        if (!done) {
        ...
        tipologiaProdotto = tipologiaProdottoDAO.findTipologiaByName(nomeTipologia);
