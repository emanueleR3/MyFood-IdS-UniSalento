...
public class RemoveIngrediente implements IIngredienteOperation{
    ...
    public RemoveIngrediente(Integer idIngrediente) {
    ...
    public OperationIngredienteResult execute() {
        ...
        ingrediente = ingredienteDAO.findIngredienteById(idIngrediente);

        boolean done  = ingredienteDAO.removeIngrediente(idIngrediente);
        if (!done) {
    ...
    public OperationIngredienteResult undo() {
        ...
        idIngrediente = ingredienteDAO.getLastInsertId();
